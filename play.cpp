...
int countA = 0;         //the number of A that check one of the all[3024]
int countB = 0;         //the number of B that check one of the all[3024]
int a = 0;              //the number of A that the player give to me
int b = 0;              //the number of B that the player give to me
